"""video processor class for Omega17VL."""
...
class Omega17VLVideoProcessorInitKwargs(VideosKwargs, total=False):
    patch_size: int
...
@add_start_docstrings(
    "Constructs a fast Omega17VL image processor that dynamically resizes videos based on the original videos.",
...
class Omega17VLVideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = Omega17VLVideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[Omega17VLVideoProcessorInitKwargs]):
...
__all__ = ["Omega17VLVideoProcessor"]
