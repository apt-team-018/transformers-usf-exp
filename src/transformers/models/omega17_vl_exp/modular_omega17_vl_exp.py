...
class Omega17VLExpTextConfig(PreTrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            Vocabulary size of the Omega17-VL-EXP model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`Omega17VLExpModel`]
    ...
    >>> # Initializing a Omega17VLExp style configuration
    >>> configuration = Omega17VLExpConfig()

    >>> # Initializing a model from the model style configuration
    ...
    # Default tensor parallel plan for base model `Omega17VLExp`
    base_model_tp_plan = {
...
class Omega17VLExpForConditionalGeneration(Qwen3VLForConditionalGeneration):
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = Omega17VLExpForConditionalGeneration.from_pretrained("mode-path", dtype="auto", device_map="auto")
